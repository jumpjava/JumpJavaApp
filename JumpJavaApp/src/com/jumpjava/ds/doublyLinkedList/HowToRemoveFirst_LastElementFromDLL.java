 ...
 * Author  : JumpJava.com
 * JAVA    : 1.7
 * Program : 13.How to delete first & Last node from a given Doubly Linked List in Java.
 * */
package com.jumpjava.ds.doublyLinkedList;

public class HowToRemoveFirst_LastElementFromDLL {

	private ListNode head;
	private ListNode tail;
	private int length;

	public HowToRemoveFirst_LastElementFromDLL() {
	...
	public static void main(String[] args) {
		...
		HowToRemoveFirst_LastElementFromDLL dll = new HowToRemoveFirst_LastElementFromDLL();
